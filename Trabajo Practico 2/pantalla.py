...
class New_Toplevel_1:
    def __init__(self, top=None):
        ...
        self.labelServidorPop.configure(width=137)
        ...
        self.conectar_btn.configure(width=98)
        ...
        self.servidor_entry.configure(width=174)
        ...
        self.frecuencia_lb.configure(text='''Frecuencia:''')
        ...
        self.frecuencia_entry.configure(cursor="fleur")
        ...
        self.estado_conexion_info.configure(width=271)
        ...
        self.estado_conexion_lb.configure(width=177)
