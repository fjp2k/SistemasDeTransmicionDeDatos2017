...
class Trabajo_Practico_1:
    def __init__(self, top=None):
        ...
        self.baudiosEntry.place(relx=0.43, rely=0.24, relheight=0.04
                , relwidth=0.2)
        ...
        self.intentosEntry.place(relx=0.43, rely=0.19, relheight=0.04
                , relwidth=0.2)
        ...
        self.tramasSolicitudLb.configure(width=330)
        ...
        self.variable1Entry.configure(width=250)
        ...
        self.variable2Entry.configure(width=250)
        ...
        self.variable3Entry.configure(width=250)
        ...
        self.variable4Entry.configure(width=250)
        ...
        self.direccionIpLb.configure(cursor="fleur")
        ...
        self.puertoTCPEntry.configure(width=250)
        ...
        self.puertoSerialRB.configure(width=197)
