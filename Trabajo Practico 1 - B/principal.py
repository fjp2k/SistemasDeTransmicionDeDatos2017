...
class Trabajo_Practico_1:
    def __init__(self, top=None):
        ...
        self.puertoEntry.place(relx=0.17, rely=0.02, relheight=0.04
                , relwidth=0.25)
        ...
        self.dispositivoEntry.place(relx=0.17, rely=0.06, relheight=0.04
                , relwidth=0.25)
        ...
        self.Label3.place(relx=0.04, rely=0.06, height=30, width=130)
        ...
        self.Label4.place(relx=0.04, rely=0.15, height=30, width=130)
        ...
        self.Label5.place(relx=0.43, rely=0.11, height=30, width=190)
        ...
        self.Label6.place(relx=0.04, rely=0.11, height=30, width=130)
        ...
        self.Label7.place(relx=0.44, rely=0.15, height=30, width=190)
        ...
        self.Label8.place(relx=0.44, rely=0.06, height=30, width=190)
        ...
        self.direccionEntry.place(relx=0.17, rely=0.11, relheight=0.04
                , relwidth=0.25)
        ...
        self.timeoutEntry.place(relx=0.63, rely=0.02, relheight=0.04
                , relwidth=0.25)
        ...
        self.baudiosEntry.place(relx=0.63, rely=0.11, relheight=0.04
                , relwidth=0.25)
        ...
        self.variablesEntry.place(relx=0.63, rely=0.15, relheight=0.04
                , relwidth=0.25)
        ...
        self.intentosEntry.place(relx=0.63, rely=0.06, relheight=0.04
                , relwidth=0.25)
        ...
        self.funcionCombo.place(relx=0.17, rely=0.15, relheight=0.04
                , relwidth=0.25)
        ...
        self.Scrolledlistbox1.place(relx=0.25, rely=0.38, relheight=0.23
                , relwidth=0.33)
        ...
        self.conectarBtn.place(relx=0.06, rely=0.42, height=50, width=120)
        ...
        self.desconectarBtn.place(relx=0.06, rely=0.51, height=50, width=120)
        ...
        self.Scrolledlistbox2.place(relx=0.61, rely=0.38, relheight=0.23
                , relwidth=0.33)
        ...
        self.Scrolledlistbox3.place(relx=0.25, rely=0.69, relheight=0.29
                , relwidth=0.68)
        ...
        self.hexaBtn.place(relx=0.06, rely=0.71, height=40, width=120)
        ...
        self.decimalBtn.place(relx=0.06, rely=0.78, height=40, width=120)
        ...
        self.binarioBtn.place(relx=0.06, rely=0.86, height=40, width=120)
        ...
        self.Label10.place(relx=0.31, rely=0.34, height=21, width=200)
        ...
        self.Label11.place(relx=0.68, rely=0.34, height=21, width=200)
        ...
        self.Label9.place(relx=0.5, rely=0.63, height=31, width=200)
        ...
        self.estadoLabel.place(relx=0.08, rely=0.63, height=21, width=81)
        self.estadoLabel.configure(activebackground="#f9f9f9")
        self.estadoLabel.configure(activeforeground="black")
        self.estadoLabel.configure(background="#d9d9d9")
        self.estadoLabel.configure(disabledforeground="#a3a3a3")
        self.estadoLabel.configure(foreground="#5337f2")
        self.estadoLabel.configure(highlightbackground="#d9d9d9")
        self.estadoLabel.configure(highlightcolor="black")
        self.estadoLabel.configure(text='''Desconectado''')

        self.Label12 = Label(top)
        self.Label12.place(relx=0.07, rely=0.2, height=30, width=130)
        ...
        self.EntryVariable1.place(relx=0.17, rely=0.2, relheight=0.04
                , relwidth=0.25)
        self.EntryVariable1.configure(background="white")
        self.EntryVariable1.configure(disabledforeground="#a3a3a3")
        self.EntryVariable1.configure(font="TkFixedFont")
        self.EntryVariable1.configure(foreground="#000000")
        self.EntryVariable1.configure(highlightbackground="#d9d9d9")
        self.EntryVariable1.configure(highlightcolor="black")
        self.EntryVariable1.configure(insertbackground="black")
        self.EntryVariable1.configure(selectbackground="#c4c4c4")
        self.EntryVariable1.configure(selectforeground="black")

        self.Label13 = Label(top)
        self.Label13.place(relx=0.07, rely=0.25, height=30, width=130)
        ...
        self.Label13.configure(text='''Variable 2''')

        self.EntryVariable2 = Entry(top)
        self.EntryVariable2.place(relx=0.17, rely=0.25, relheight=0.04
                , relwidth=0.25)
        self.EntryVariable2.configure(background="white")
        self.EntryVariable2.configure(disabledforeground="#a3a3a3")
        self.EntryVariable2.configure(font="TkFixedFont")
        self.EntryVariable2.configure(foreground="#000000")
        self.EntryVariable2.configure(highlightbackground="#d9d9d9")
        self.EntryVariable2.configure(highlightcolor="black")
        self.EntryVariable2.configure(insertbackground="black")
        self.EntryVariable2.configure(selectbackground="#c4c4c4")
        self.EntryVariable2.configure(selectforeground="black")

        self.Label14 = Label(top)
        self.Label14.place(relx=0.5, rely=0.2, height=30, width=190)
        ...
        self.Label14.configure(text='''Variable 3''')

        self.Label15 = Label(top)
        self.Label15.place(relx=0.5, rely=0.25, height=30, width=190)
        ...
        self.Label15.configure(text='''Variable 4''')

        self.EntryVariable3 = Entry(top)
        self.EntryVariable3.place(relx=0.63, rely=0.2, relheight=0.04
                , relwidth=0.25)
        self.EntryVariable3.configure(background="white")
        self.EntryVariable3.configure(disabledforeground="#a3a3a3")
        self.EntryVariable3.configure(font="TkFixedFont")
        self.EntryVariable3.configure(foreground="#000000")
        self.EntryVariable3.configure(highlightbackground="#d9d9d9")
        self.EntryVariable3.configure(highlightcolor="black")
        self.EntryVariable3.configure(insertbackground="black")
        self.EntryVariable3.configure(selectbackground="#c4c4c4")
        self.EntryVariable3.configure(selectforeground="black")

        self.EntryVariable4 = Entry(top)
        self.EntryVariable4.place(relx=0.63, rely=0.25, relheight=0.04
                , relwidth=0.25)
        self.EntryVariable4.configure(background="white")
        self.EntryVariable4.configure(disabledforeground="#a3a3a3")
        self.EntryVariable4.configure(font="TkFixedFont")
        self.EntryVariable4.configure(foreground="#000000")
        self.EntryVariable4.configure(highlightbackground="#d9d9d9")
        self.EntryVariable4.configure(highlightcolor="black")
        self.EntryVariable4.configure(insertbackground="black")
        self.EntryVariable4.configure(selectbackground="#c4c4c4")
        self.EntryVariable4.configure(selectforeground="black")
