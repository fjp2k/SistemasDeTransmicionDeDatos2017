...
def armarHeaderFuncion06(direccionRecibida,cantVariablesRecibidas,dispositivoRecibido):
    global transaction
    transaction += 1
    ...
    armarTramaFuncion06(headerTCP,direccionRecibida,cantVariablesRecibidas)


def armarTramaFuncion06(headerTCP,direccionRecibida,cantVariablesRecibidas):
    intFunctionCode= 06
...
if(conectarSocket()):
    armarHeaderFuncion06(500,295,1)
else:
    print("todo mal")
