...
class Trabajo_Practico_1:
    def __init__(self, top=None):
        ...
        self.Label6.configure(width=130)
        ...
        self.intentosEntry.configure(width=250)
        ...
        self.decimalBtn.place(relx=0.06, rely=0.75, height=40, width=120)
        ...
        self.binarioBtn.place(relx=0.06, rely=0.83, height=40, width=120)
        ...
        self.Label9.configure(width=227)
